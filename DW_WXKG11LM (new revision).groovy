...
metadata {
	definition (name: "DW_WXKG11LM (new revision)", namespace: "skswj22", author: "skswj22", minHubCoreVersion: "000.022.0002", ocfDeviceType: "x.com.st.d.remotecontroller") {
		capability "Actuator"
		capability "Battery"
		capability "Button"
...
private mapButtonEvent(value) {
	// WXKG11LM (new revision) message 
	// values: 0: hold, 1 = push, 2 = double-click, 255 = release
	def messageType = [0: "held", 1: "single-clicked", 2: "double-clicked", 16: "held", 17: "released", 18: "shaken", 255: "released"]
	def eventType = [0: "held", 1: "pushed", 2: "pushed_2x", 16: "held", 17: "pushed", 18: "pushed", 255: "release"]
	...
	if (value == 17 || value == 255) {
		...
		updateLastPressed("Pressed")
		if (eventType[value] == "pushed" || eventType[value] == "pushed_2x")
